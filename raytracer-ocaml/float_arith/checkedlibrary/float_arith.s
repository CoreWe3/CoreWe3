...
:min_caml_fadd_L1
	...
	BEQ	r7	r8	:min_caml_fadd_L2 	#r9 = man
	SUB	r9	r5	r6
...
:min_caml_fadd_L4
	SHL	r10	r15	r4
	AND	r10	r9	r10
	BEQ	r10	r0	:min_caml_fadd_L4_1
	BEQ	r0	r0	:min_caml_fadd_L5
:min_caml_fadd_L4_1
	SUB	r4	r4	r15
	BLE	r4	0	:min_caml_fadd_L5	
	BEQ	r0	r0	:min_caml_fadd_L4	#BLE+BEQmatomerareru?
:min_caml_fadd_L5
	BLE	r14	r4 	:min_caml_fadd_L6
...
:min_caml_fsub
	...
	SHL	r13	r15	r14
	SHR	r3	r2	r14
	BEQ	r3	r0	:min_caml_fsub_L1
	SUB	r13	r13	r15
	AND	r2	r2	r13
	BEQ	r0	r0	:min_caml_fsub_L2
:min_caml_fsub_L1
	OR 	r2	r2	r13
:min_caml_fsub_L2
	JSUB	:min_caml_fadd
